...
const passwordMatchRule = (value) => value === changePasword.password || "Las contraseñas no coinciden";
...
const submitForm = () => {
    ...
    if ( !changePasword.email || !changePasword.password || !changePasword.confirmPassword )
    {
      return;
    }
